...
app.get('/api/analysis', (req, res) => {
  ...
  if (date !== 'all') {
    ...
    const dateCondition = date === 'date1'
      ? "timestamp BETWEEN '2025-01-04 00:00:00' AND '2025-01-04 17:00:00'"
      : "timestamp BETWEEN '2025-01-04 17:01:00' AND '2025-01-06 00:00:00'";
  ...
  const query = `
    SELECT 
      ...
      (SUM(CASE WHEN status != 3 THEN 1 ELSE 0 END) / NULLIF(COUNT(*), 0)) * 100 AS badDebtRate,
